...
\begin{table}[h]
  ...
  \caption{\textbf{S-OWMI V1 Scorecard --- Llama-3.1-8B and Qwen2.5-7B.}
    ...
    \lvltwo~40--74, \lvlone~$<40$. Step 1 (Token Fertility) is reported separately in
    Appendix~A and Step 2 (Dialectal Coverage) is qualitative; both are excluded from
    this scorecard. The V1 score is therefore computed over Steps 3--6 only; weights:
    P3$\times$15, P4$\times$30, P5$\times$15, P6$\times$15 (V1 partial; P1$\times$10 and
    P2$\times$15 not folded into the score).}
  \label{tab:scorecard}
  \smallskip
