...
% TODO (Nico): el 20% de revisión humana AÚN NO se ejecutó (los CSV *_human_review.csv
% están vacíos). Si NO se corre antes de entregar, cambiar "supplemented by a 20% human
% calibration review" por "for which a 20% human-calibration protocol is provided" para no
% afirmar algo no hecho. Si SÍ se corre, dejar como está y agregar el kappa.
